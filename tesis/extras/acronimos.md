...
\begin{description}[leftmargin=3.5cm, style=nextline, font=\bfseries]
  ...
  \item[AUC] Area Under the ROC Curve (área bajo la curva ROC)
  ...
  \item[RMSE] Root Mean Squared Error (raíz del error cuadrático medio)
  \item[RNF] Requisito No Funcional
  \item[ROC] Receiver Operating Characteristic
  \item[SoC] State of Charge (estado de carga)
  \item[UNE] Unión Eléctrica de Cuba
\end{description}

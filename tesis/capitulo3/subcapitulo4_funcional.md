...
Todos los casos del catálogo arrojaron un veredicto satisfactorio: el comportamiento observado coincidió con el esperado en cada uno, por lo que la tasa de aprobación fue del 100 %. La ejecución de la lógica de negocio se respaldó con **819 pruebas unitarias automatizadas** (678 en el *backend* con pytest y 141 en el *frontend* con Vitest), que verifican las funciones de cálculo energético, la ingeniería de características del modelo solar, la inferencia de *Havana v1*, la simulación de batería, la autenticación y la autorización, la integración con el servicio de clima, las operaciones CRUD sobre los activos y los componentes de la interfaz, entre otras; su distribución por archivo se recoge en el Anexo B.

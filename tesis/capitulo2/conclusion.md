...
- Las cuatro vistas arquitectónicas (cliente–servidor, n-capas, flujo de datos y repositorio) y el diseño documental en once colecciones sostienen la reutilización y la flexibilidad del sistema.
...
Con el diseño definido, el Capítulo 3 somete la solución a un análisis experimental sobre la microrred de la CUJAE: entrena y evalúa los modelos, comprueba el sistema mediante casos de prueba y muestra su funcionamiento.
